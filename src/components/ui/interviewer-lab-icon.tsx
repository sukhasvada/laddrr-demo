...
export const InterviewerLabIcon = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
    <svg
        version="1.1"
        id="Layer_1"
    ...
    >
        <g>
            <path style={{ fill: "hsl(var(--secondary))" }} d="M26,29h8c0.551,0,1-0.741,1-1.292v-1c0-0.197,0.059-0.244,0.168-0.408l0.963-1.3H36 c-0.552,0-1-0.448-1-1c0-0.551-0.449-1-1-1h-8c-0.551,0-1,0.156-1,0.708v4C25,28.259,25.449,29,26,29z M27,25h6v2h-6V25z"/>
            <circle style={{ fill: "hsl(var(--primary))" }} cx="12" cy="17.708" r="4"/>
            <path style={{ fill: "hsl(var(--secondary))" }} d="M20,8c0.552,0,1,0.155,1,0.708v1l1.2-1.454C22.389,8.002,22.685,8,23,8h8c0.551,0,1-0.741,1-1.292 v-4C32,2.156,31.551,2,31,2H19c-0.551,0-1,0.156-1,0.707v4C18,7.259,18.449,8,19,8H20z M20,4h10v2H20V4z"/>
            <circle style={{ fill: "hsl(var(--primary))" }} cx="44" cy="17.708" r="4"/>
            <path style={{ fill: "hsl(var(--primary))" }} d="M46,28h-4v2.708v1v2C42,34.26,41.552,35,41,35h-8v2h3h2h6v-6h2v6.708C46,38.26,45.552,39,45,39h-7 c-0.551,0-1,0.156-1,0.708V54h2V42.708C39,42.155,39.448,42,40,42h9V30.708C49,29.053,47.654,28,46,28z"/>
            <path style={{ fill: "hsl(var(--primary))" }} d="M14,33.708v-2v-1V28h-4c-1.654,0-3,1.053-3,2.708V42h9c0.552,0,1,0.155,1,0.708V54h2V39.708 C19,39.156,18.551,39,18,39h-7c-0.552,0-1-0.74-1-1.292V31h2v6h6h2h3v-2h-8C14.448,35,14,34.26,14,33.708z"/>
            <g>
